...
describe ManageIQ::Providers::Microsoft::InfraManager::Refresher do
  ...
  it "will perform a full refresh" do
    ...
    # Relationship.puts_arranged_resources(@ems.descendants_arranged)
  ...
  def assert_table_counts
    ...
    Vm.count.should == 73
    VmOrTemplate.count.should == 89
    CustomAttribute.count.should == 0
    CustomizationSpec.count.should == 0
    Disk.count.should == 73
    GuestDevice.count.should == 14
    Hardware.count.should == 92
    Lan.count.should == 4
    MiqScsiLun.count.should == 0
    MiqScsiTarget.count.should == 0
    Network.count.should == 73
    OperatingSystem.count.should == 92
    Snapshot.count.should == 14
    Switch.count.should == 4
    SystemService.count.should == 0
    Relationship.count.should == 96

    MiqQueue.count.should == 89
  ...
  def assert_ems
    ...
    @ems.vms_and_templates.size.should eq(89)
    @ems.vms.size.should eq(73)
    @ems.miq_templates.size.should eq(16)
  ...
  def assert_specific_vm
    ...
    v.hardware.guest_devices.size.should eq(2)
    dvd1 = v.hardware.guest_devices[0]
    dvd2 = v.hardware.guest_devices[1]

    dvd1.should have_attributes(
      :device_name     => "CentOS-7-x86_64-Minimal-1503-01",
      :device_type     => "cdrom",
      :filename        => "C:\\Users\\administrator.CFME-QE-VMM-AD\\Downloads\\CentOS-7-x86_64-Minimal-1503-01.iso",
      :controller_type => "IDE",
      :present         => true,
      :start_connected => true,
    )

    dvd2.should have_attributes(
      ...
      [EmsFolder, "Datacenters", {:is_datacenter => false}] => {
        [EmsFolder, "SCVMM", {:is_datacenter => true}] => {
          ...
          [EmsFolder, "vm", {:is_datacenter => false}] => {
           ...
           [ManageIQ::Providers::Microsoft::InfraManager::Vm, "taigotest", {:ems_ref => "040381ac-9053-11e5-b754-8438355b2b94"}]       => {},
           [ManageIQ::Providers::Microsoft::InfraManager::Vm, "taigotest", {:ems_ref => "05748f04-9053-11e5-b754-8438355b2b94"}]       => {},
           ...
           [ManageIQ::Providers::Microsoft::InfraManager::Vm, "vm_extrap_4", {:ems_ref => "0479ce48-9053-11e5-b754-8438355b2b94"}]       => {},
           [ManageIQ::Providers::Microsoft::InfraManager::Vm, "vm_extrap_4", {:ems_ref => "046b6fd8-9053-11e5-b754-8438355b2b94"}]       => {},
